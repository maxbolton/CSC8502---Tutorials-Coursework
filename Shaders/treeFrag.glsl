...
void main(void) {
    ...
    float fogWave = (sin(dt*0.5) + 1.0); // Normalized to 0-1 range
    ...
    float fogFactor = clamp((100.0 - camDistance) / 100.0, 0.0, 0.4);
    ...
    bool isUp = abs(verticalNorm) > clamp(fogFactor, 0.1, 0.8);
